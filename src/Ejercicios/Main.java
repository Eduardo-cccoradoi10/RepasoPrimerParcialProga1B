...
public class Main {
    ...
    // Scanner global para usarlo en todos los métodos
    ...
    public static void main(String[] args) {
        ...
        // Menú principal con ciclo para repetir hasta que el usuario decida salir
        do {
            System.out.println("\n===== MENU DE EJERCICIOS =====");
            ...
            System.out.println("8. Clasificacion de hora");
            ...
            // Switch para llamar al método correspondiente
            switch (opcion) {
    ...
    // 1) Suma de números divisibles entre 4
    public static void ejercicio1() {
        int n = sc.nextInt();
        int suma = 0;

        // Recorre del 1 al n y suma los que son divisibles entre 4
        for (int i = 1; i <= n; i++)
            if (i % 4 == 0) suma += i;
    ...
    public static void ejercicio3() {
        ...
        // Lee n números y clasifica cada uno
        for (int i = 0; i < n; i++) {
            int x = sc.nextInt();
            if (x > 0) pos++;
            else if (x < 0) neg++;
    ...
    public static void ejercicio4() {
        ...
        // Recorre solo pares sumando y contando
        for (int i = 2; i <= n; i += 2) {
            suma += i;
            cont++;
        }
        ...
        if (cont > 0)
            System.out.println("Promedio = " + (suma / (double) cont));
        else
    ...
    // 6) Verificar múltiplo de 7 o 11
    public static void ejercicio6() {
        int n = sc.nextInt();

        // Verifica con OR lógico
        if (n % 7 == 0 || n % 11 == 0)
    ...
    // 7) Divisible entre 3 pero no entre 2
    public static void ejercicio7() {
        int n = sc.nextInt();

        // Recorre y filtra con condiciones
        for (int i = 1; i <= n; i++)
            if (i % 3 == 0 && i % 2 != 0)
                System.out.println(i);
    }

    // 8) Clasificación de hora
    public static void ejercicio8() {
        int h = sc.nextInt();

        // Clasifica según el rango
        if (h >= 0 && h < 12) System.out.println("Manana");
        else if (h < 18) System.out.println("Tarde");
        else System.out.println("Noche");
    }

    // 9) Convertir número a romano usando switch
    ...
    // 12) Tabla de división del 1 al 10
    ...
    // 14) Verificar si un número es triangular
    public static void ejercicio14() {
        int n = sc.nextInt();
        int suma = 0;
        boolean triangular = false;

        // Suma progresiva 1 + 2 + 3 + ... hasta alcanzar o pasar n
    ...
    // 15) Promedio de números negativos
    public static void ejercicio15() {
        ...
        if (cont > 0)
            System.out.println("Promedio negativos = " + (suma / (double) cont));
        else
    ...
    // 17) Verificar si un número es potencia de 2
    ...
    // 19) Suma del 1 al n: par o impar
